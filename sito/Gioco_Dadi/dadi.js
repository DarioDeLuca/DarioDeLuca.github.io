...
function Verifica (a, count){
	...
	if(errore_giocatore < falso_errore){
		...
		dialogo.innerHTML="Peccato, hai perso, sapevo avrei vinto puntando su "+scelta_pc+" tiri!"
		document.getElementById('bottone_1').disabled=true
		document.getElementById('bottone_2').disabled=true
	}
	if(a===scelta_pc){
		...
		console.log("parità")
		dialogo.innerHTML="Impossibile?! Come hai fatto a capire volessi scommettere anche io su "+scelta_pc+" tiri?"
		document.getElementById('bottone_1').disabled=true
		document.getElementById('bottone_2').disabled=true
	}
}
